package com.natwest.boa.hackathon.model;
...
public class OBCashAccountDebtor {
    ...
    public OBCashAccountDebtor schemeName(String schemeName) {
    ...
    public OBCashAccountDebtor identification(String identification) {
    ...
    public OBCashAccountDebtor name(String name) {
        this.name = name;
        return this;
    }
    ...
    public OBCashAccountDebtor secondaryIdentification(String secondaryIdentification) {
    ...
    public boolean equals(Object o) {
        ...
        OBCashAccountDebtor obCashAccountDebtor4 = (OBCashAccountDebtor) o;
