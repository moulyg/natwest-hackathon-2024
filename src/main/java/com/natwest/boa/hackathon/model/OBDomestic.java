...
public class OBDomestic {
    ...
    private String sustainableProductsAmount;
    ...
    public String getSustainableProductsAmount() {
        return sustainableProductsAmount;
    }

    public void setSustainableProductsAmount(String sustainableProductsAmount) {
        this.sustainableProductsAmount = sustainableProductsAmount;
    }
